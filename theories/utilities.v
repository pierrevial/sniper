...
(******)
(** Temporay: should rather be written in OCaml *)
Open Scope string_scope.
...
Elpi Tactic clearbody_llist_tVar.
Elpi Accumulate lp:{{
  ...
  pred unwrap_bis i: term, o: list term.
    unwrap_bis (app [{{@cons }}, _ , X, X']) L :- coq.say "kikooooooooo",
...
Proof.
intros n b r k. pose  ( [ [tVar "b"; tVar "r"] ; [tVar "k" ]]) as l0.
Fail elpi clearbody_llist_tVar l0.
elpi clearbody_llist_tVar ( [ [tVar "b"; tVar "r"] ; [tVar "k" ]]).
exact b.
Show Proof.
Qed.
